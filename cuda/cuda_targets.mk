...
$(CUDA_OBJ_DIR)/bdssim_sm61.o: src/compute/cuda/bdssim.cu
...
$(CUDA_OBJ_DIR)/bdssim_sm75.o: src/compute/cuda/bdssim.cu
	@mkdir -p $(CUDA_OBJ_DIR)
...
$(CUDA_OBJ_DIR)/bdssim_sm86.o: src/compute/cuda/bdssim.cu
	@mkdir -p $(CUDA_OBJ_DIR)
...
$(CUDA_OBJ_DIR)/bdssim_sm89.o: src/compute/cuda/bdssim.cu
	@mkdir -p $(CUDA_OBJ_DIR)
...
$(CUDA_OBJ_DIR)/bdssim_sm120plus.o: src/compute/cuda/bdssim.cu
	@mkdir -p $(CUDA_OBJ_DIR)
...
$(CUDA_OBJ_DIR)/bdssim_modern.o: src/compute/cuda/bdssim.cu
	@mkdir -p $(CUDA_OBJ_DIR)
