...
extern "C" void map_gui_set_control_defaults(const sim_config_t *cfg) {
  ...
  g_ctrl.interference_selection = cfg->interference_selection;
...
extern "C" void map_gui_get_control_config(sim_config_t *cfg,
  ...
  cfg->interference_selection = g_ctrl.interference_selection;
  cfg->interference_mode = (g_ctrl.interference_selection == 1);
