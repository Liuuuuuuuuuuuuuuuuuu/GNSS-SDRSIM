...
// Hover-help overlay helpers are kept as an unwired placeholder module.
// Keep disabled by default to avoid accidental assumptions about active
// hover-region semantics.
#ifndef GUI_ENABLE_MAP_HOVER_HELP_OVERLAY
#define GUI_ENABLE_MAP_HOVER_HELP_OVERLAY 0
#endif
