...
SETUP_OUT="$(sudo /home/user/GNSS-SDRSIM/scripts/wifi/setup_alfa_awus046nh.sh ${IFACE_ARG:+"$IFACE_ARG"})"
echo "$SETUP_OUT"
...
echo "[auto] starting bds-sim with BDS_WIFI_RID_IFACE=${BDS_WIFI_RID_IFACE}"
exec /home/user/GNSS-SDRSIM/bds-sim "$@"
